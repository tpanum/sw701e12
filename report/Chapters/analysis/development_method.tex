...
Therefore the best match for this project is an agile development method.
The useful aspect of the agile development methods is their iterative nature.
...
The practices taken from Scrum are:
\begin{itemize}
