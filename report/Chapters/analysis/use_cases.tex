...
These five terms -- user, drone, permission, company, and role -- forms the security - and permissions aspect of a user's interaction with \projectname{} and are used in the use cases in Table~\ref{tab:use_cases}.
