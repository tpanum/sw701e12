...
\begin{itemize}
	\item We find that the various Linux distributions are easier to use for project like these, where various web applications and server-side scripts are executed on the server. \fixme{Why? give examples}
...
All of the above are semantic equivalent\fixme{source?} and runs on Linux Debian.
