...
%Link til design
The development method used in this project makes use of acceptance tests, as described in Section~\ref{sec:developmet_method}.
...
A use case may have several acceptance tests associated with it.
In Figure~\ref{tab:acceptance_tests1} and Figure~\ref{tab:acceptance_tests2} the column Use Case ID refers to the use case the acceptance is associated with.
...
\begin{tabular}{ | l | l | p{8cm} | }
  \hline
	...
	24 & 15 & The user with rights can add privileges to the role.  \\ \hline
	25 & 15 & The user with rights can remove privileges from the role.  \\ \hline
	26 & 16 & The user with rights can add users to roles.  \\ \hline
	27 & 16 & The user with rights can remove users from roles.  \\ \hline
