...
\begin{tabular}{ | l | l | p{8cm} | }
  \hline
	...
	25 & 15 & The user with rights can add can add privileges to the role.  \\ \hline
	26 & 15 & The user with rights can remove privileges from the role.  \\ \hline
	27 & 16 & The user with rights can add users to roles.  \\ \hline
	28 & 16 & The user with rights can remove users from roles.  \\ \hline
	29 & 17 & The user is not able to pilot a drone that is already being piloted. \\
  \hline
\end{tabular}
