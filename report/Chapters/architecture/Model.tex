...
\subsubsection{Role}
Roles are signed to bind multiple Privileges and Users using one component to save the administrators some work.
...
This table links the granting of a Privilege with the actual Privilege. 
The reason for having this table and not just link the two granting-tables \verb+User_Privileges+ and \verb+Privileges_Roles+ is that in the case a privilege changes, one common link between the link and its affiliations exists, making it easier to maintain the system. 
