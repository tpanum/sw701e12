...
The primary purpose of the system is to connect users and drones to allow the user to interact with a drone by watching its video fee, controlling its movements or both.
...
Only a login-page will be visible when the system is visited by a guest.
...
\subsubsection{Role}
Roles are the glue that binds Users, Drones and system Privileges. 
...
Lets call this one ``Control Drone #4''.
