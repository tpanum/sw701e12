...
This numbering will be managed in the \verb+Flight_Action_Relationship+\fixme{Opdater dette når den gives et nyt navn} with the field \verb+rank+.
An action will be linked to an instruction.
Instruction represent the set of AT commands which can be send to the drone to control.\fixme{Ref til AT command sektion når den skrives}
