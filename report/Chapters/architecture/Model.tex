...
The core functionality of the system is connecting users and drones.
Therefore they represent the primary entities which must be represented in \projectname{}.
