...
The setup can be seen in Figure\fxfatal{lav figur}

FIGUR af Gstreamer setup med protokoller osv.
...
\deno{SP} is therefore: \verb+tcpclientsrc host=192.168.1.1 port=5555 ! paveparse ! rtph264pay ! udpsink host=224.1.1.1 port=5123 auto-multicast=true+.
...
The \verb+udpsrc+ element of \deno{CP}