...
The reason for communicating through \deno{DB}, is to adapt to the asynchronous behaviour of the web.
This also allows for running multiple instances of \deno{D}, as they can use a shared quene represented in \deno{DB}.
