...
The JSON views will be used for asynchronously fetching data from the server, while the HTML views will be used for actions that require user input. \fxfatal{Bør Object Model snakke om Affiliate Privilege og Session?}
