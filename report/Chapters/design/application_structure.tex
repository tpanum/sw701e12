...
It should be noted though, that \deno{M} is capable of handling multiple \deno{B}'s at the same time. \\
...
As requests can happen asynchronously, a relational database denoted \deno{DB} is an obvious choice to store this data, as it is able to receive data at any time and let other processes handle it later, hence helping to minimize potential data loss. \\
