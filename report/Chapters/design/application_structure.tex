...
The response output of \deno{M} needs to be dynamic based on the user, e.g. Acceptance test 2 in Table~\ref{tab:acceptance_tests1}, which requires \deno{M} to be capable of processing data and store it in the database.
