...
The system will contain the following objects: \deno{Affiliate Privilege}, \deno{Company}, \deno{Drone}, \deno{Privilege}, \deno{Role}, \deno{Session}, \deno{User}. The relationship between the objects can be seen in Figure~\ref{fig:UML_class_diagram}.
