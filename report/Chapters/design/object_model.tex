...
Rich relationship models have a PK. These are represented by having both objects in lowercase but only the last object is pluralized, e.g. company\_roles.\\
