...
The login credentials are stored on \deno{B} and it is used to uphold the users' authentication.\fixme{Dette er ikke korrekt. Sessions ligger server side, og indeholder ikke credentials.}
